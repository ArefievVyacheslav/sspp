...
module.exports = function getOptions (gender, productId) {
  ...
  const menOptions = [
    ...
    },
    {
      headers: {
        ...
        'x-sm-request-id': 'ea8a8436-7c7f',
        'x-sm-tracing-id': '12bff4ba-20997632'
      }
    }
  ]
  menOptions[1].page = 1
  ...
  const womenOptions = [
    ...
    },
    {
      headers: {
        ...
        'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.0.0 Safari/537.36',
        'x-sm-accept-language': 'ru-RU',
        'x-sm-request-id': '1c3e111b-cb09',
        'x-sm-tracing-id': 'ec38385f-20765323'
      }
    }
  ]
  ...
  const productOptions = ['https://www.sportmaster.ru/ga-api/v1/product-view/27888390299', {
    headers: {
      ...
      'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.0.0 Safari/537.36',
      'x-sm-accept-language': 'ru-RU',
      'x-sm-request-id': '923803b9-6fff',
      'x-sm-tracing-id': 'cce267e3-17984865'
    }
  }]
