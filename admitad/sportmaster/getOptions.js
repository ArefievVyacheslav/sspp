  ...
  const menOptions = [
    ...
    },
    {
      headers: {
        ...
        'x-sm-request-id': '3c9dd05d-a84a',
        'x-sm-tracing-id': 'da0b6e01-18133765'
      }
    }
  ]
  ...
  const womenOptions = [
    ...
    },
    {
      headers: {
        ...
        'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.0.0 Safari/537.36',
        'x-sm-accept-language': 'ru-RU',
        'x-sm-request-id': 'f98f91e8-5184',
        'x-sm-tracing-id': '073d0e0c-14762460'
      }
    }
  ]

  const productOptions = [
    'https://www.sportmaster.ru/ga-api/v1/product-view/' + productId || '', {
      headers: {
        'authority': 'www.sportmaster.ru',
        ...
        'cookie': 'UDID=3a5ba8db-2639-456f-a358-e9e7dd516168; SMID=eyJhbGciOiJSUzI1NiJ9..BwW0N_Ze3OgHZk7ny5tCJR-EUyX7yHgWYNNmKH03qNN92Tq8pUWMne80Q2s3dTB1mX-jPPHAc_HbgMyRB0NB6XKLj91pwtSxGmpyVKKfHZ895ckbEEqo4TOvDA24c6-FJ1E1GtHhbKWYJzTiakGkG5A5bM_DSkatHH82Mw5ScS2PQG6AIONr7gNEtoKtu3t8ReEUO6eiOaCAyLioAReKFTyOefld_rqIjHSbtgRGr6SkGN8sdbS2iWS5_4EEOVOpnBtYHw72jn5yohNKBV6CHtj7SWozg-6ikn68kRcK_fZaEIyLaqQpC3rh0LkWhv_CTAqxKJATYWal1PCyGH5jgw; SMAUTH=eyJpZCI6IjE5ZTMxYTc5LWMwYTMtNGM2MC05MzYzLTFlNDkyNWE3ODA0OCIsInN0IjoiUkVUVVJORUQiLCJ0bSI6MTY4Mjg2MDUxOH0=; qrator_jsr=1686495675.044.pBrAGabfj82eA3fw-1j510qigl391k1mafim0gq9il04en4sj-00; qrator_jsid=1686495675.044.pBrAGabfj82eA3fw-khs19qbtf7erfhlqeaovk9r6p39qgbvf',
        'dnt': '1',
        'referer': 'https://www.sportmaster.ru/product/' + productId || '' + '/',
        'sec-ch-ua': '"Not.A/Brand";v="8", "Chromium";v="114", "Google Chrome";v="114"',
        'sec-ch-ua-mobile': '?0',
        'sec-ch-ua-platform': '"Linux"',
        'sec-fetch-dest': 'empty',
        ...
        'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.0.0 Safari/537.36',
        'x-sm-accept-language': 'ru-RU',
        'x-sm-request-id': '189a2f7e-ef2d',
        'x-sm-tracing-id': 'dfc81289-10146096'
      }
    }
  ]
