...
def update_products():
    ss = get_database('ss')
    products = ss['temp_products'].find_one({ 'shop': 'brandshop'}, {'_id': False })['products']
    old_products = []
    clothes_products = ss['clothes'].find({ 'shop': 'brandshop'}, {'_id': False })
    shoes_products = ss['shoes'].find({ 'shop': 'brandshop'}, {'_id': False })
    accessories_products = ss['accessories'].find({ 'shop': 'brandshop'}, {'_id': False })
