...
const womenOptions = [
  ...
  },
  {
    headers: {
      'authority': 'www.sportmaster.ru',
      'accept-language': 'en-US,en;q=0.9,ru-RU;q=0.8,ru;q=0.7',
      'cookie': 'UDID=3a5ba8db-2639-456f-a358-e9e7dd516168; SMID=eyJhbGciOiJSUzI1NiJ9..BwW0N_Ze3OgHZk7ny5tCJR-EUyX7yHgWYNNmKH03qNN92Tq8pUWMne80Q2s3dTB1mX-jPPHAc_HbgMyRB0NB6XKLj91pwtSxGmpyVKKfHZ895ckbEEqo4TOvDA24c6-FJ1E1GtHhbKWYJzTiakGkG5A5bM_DSkatHH82Mw5ScS2PQG6AIONr7gNEtoKtu3t8ReEUO6eiOaCAyLioAReKFTyOefld_rqIjHSbtgRGr6SkGN8sdbS2iWS5_4EEOVOpnBtYHw72jn5yohNKBV6CHtj7SWozg-6ikn68kRcK_fZaEIyLaqQpC3rh0LkWhv_CTAqxKJATYWal1PCyGH5jgw; SMAUTH=eyJpZCI6IjE5ZTMxYTc5LWMwYTMtNGM2MC05MzYzLTFlNDkyNWE3ODA0OCIsInN0IjoiUkVUVVJORUQiLCJ0bSI6MTY4Mjg2MDUxOH0=; srv_id=9c935903a1a5983603abc5cf9e24b037; qrator_jsr=1686457302.166.eswBGCWb2aqKrmSh-n4m3mdfrf8nq6ld5f3oqgie5ttvpamhn-00; qrator_jsid=1686457302.166.eswBGCWb2aqKrmSh-40jmovhlduhckpqtboff0bl3hv9kn9um',
      'dnt': '1',
      'origin': 'https://www.sportmaster.ru',
      ...
      'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.0.0 Safari/537.36',
      'x-sm-accept-language': 'ru-RU',
      'x-sm-request-id': '31a516d3-49af',
      'x-sm-tracing-id': 'e829c7b2-9614281'
    }
  }
]
    ...
    const { data } = await axios.get(
      'https://www.sportmaster.ru/ga-api/v1/product-view/' + productProto.productId, {
        headers: {
          ...
          'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.0.0 Safari/537.36',
          'x-sm-accept-language': 'ru-RU',
          'x-sm-request-id': '303c72aa-861c',
          'x-sm-tracing-id': 'ab51b352-12908691'
        }
      }
    )
