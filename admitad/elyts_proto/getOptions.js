  ...
  const menOptions = [
    ...
    },
    {
      headers: {
        ...
        'dnt': '1',
        'origin': 'https://www.elyts.ru',
        'referer': 'https://www.elyts.ru/catalog/sale_/?f-availability=delivery_wo_exp,exp_delivery&f-cat=cat_aksessuary,cat_obuv,cat_odezhda&f-age_gender=age_gender_muzhchiny&f-brand=134913850299,134921380299,134922180299,134923980299,134943420299,134953520299,134957800299,134961460299,134963300299,44692390299,4526360002,4526390002,4526420002,4526530002,4526600002,45882690299,47785340299,4930740002,4930770002,4931390002,4931400002,4931840002,4931900002,4932590002,60052010299',
        ...
        'x-sm-request-id': '11d71914-a6fb',
        'x-sm-tracing-id': 'd48e71b5-16114452'
      }
    }
  ]
  menOptions[1].page = 1
  ...
  const womenOptions = [
    ...
    },
    {
      headers: {
        ...
        'dnt': '1',
        'origin': 'https://www.elyts.ru',
        'referer': 'https://www.elyts.ru/catalog/sale_/?f-availability=delivery_wo_exp,exp_delivery&f-cat=cat_aksessuary,cat_obuv,cat_odezhda&f-age_gender=age_gender_zhenschiny&f-brand=134913850299,134921380299,134922180299,134923980299,134934380299,134943420299,134953520299,134957800299,134961460299,134963300299,44692390299,4526360002,4526390002,4526420002,4526530002,4526600002,45882690299,47785340299,4930740002,4930770002,4931390002,4931400002,4931840002,4931900002,4932590002,60052010299',
        'sec-ch-ua': '"Not.A/Brand";v="8", "Chromium";v="114", "Google Chrome";v="114"',
        'sec-ch-ua-mobile': '?0',
        'sec-ch-ua-platform': '"Linux"',
        'sec-fetch-dest': 'empty',
        ...
        'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.0.0 Safari/537.36',
        'x-sm-accept-language': 'ru-RU',
        'x-sm-request-id': '0fb44ddb-c371',
        'x-sm-tracing-id': '59889108-20236764'
      }
    }
  ]
  womenOptions[1].page = 1

  const productOptions = ['https://www.elyts.ru/ga-api/v1/product-view/27888390299', {
    headers: {
      'authority': 'www.elyts.ru',
      'accept': 'application/json, text/plain, */*',
      'accept-language': 'en-US,en;q=0.9,ru-RU;q=0.8,ru;q=0.7',
      'cookie': 'UDID=02772c3a-c504-4f1d-b024-8e380b49e073; SMID=eyJhbGciOiJSUzI1NiJ9..W-rXX_3b1Tnsbgd29AuUQYXPgDhgAploVOx2ZbjvUd0JlErmIMh5zHhIRLxCp5IGyujC2ZAtIxI3ucwdVsE4lWZkUnnli0gNm9so5oD_4NtivMyjycgKOPS7gO7au72_F-vYe4rVW7r1l6jaPn7i6b5ZwDG1y5aE6rPp6bS4kGje1X-FE1_SHFC-m5pJN7rqJF3pjoA_RZnNHRJ_5FWwfs7RGstaYJDUjkU4hCHo9uBU4ru36eU08mGZKD0rwkFGAz_AYqM15wrEYc4hw23m_WUsJKZI2eLITVMdBQlMZ3oANvgVJnkVeOHe6OHMCmyRPwYe0kSRRDk5ZkpKCNpf5g; SMAUTH=eyJpZCI6IjliODQ0NjRjLTdjNDktNDljNy04MDk5LTgzYTIyMTU2ZjQ4NiIsInN0IjoiUkVUVVJORUQiLCJ0bSI6MTY5MjI5ODQ4MH0=; qrator_jsid=1692550604.910.6NtcZb9B28Q5Tdji-5u6mpn4us25b3hi2mlg5l3p8dhuh8ogg; qrator_ssid=1692550606.463.Z8pE9HbAaMNOyviJ-timidb0kup7fkotcepqik4459drs61pn',
      'dnt': '1',
      'referer': 'https://www.elyts.ru/product/27888390299/',
      'sec-ch-ua': '"Not.A/Brand";v="8", "Chromium";v="114", "Google Chrome";v="114"',
      'sec-ch-ua-mobile': '?0',
      'sec-ch-ua-platform': '"Linux"',
      'sec-fetch-dest': 'empty',
      ...
      'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.0.0 Safari/537.36',
      'x-sm-accept-language': 'ru-RU',
      'x-sm-request-id': 'ebac77f0-7967',
      'x-sm-tracing-id': '2381211f-20496746'
    }
  }]
